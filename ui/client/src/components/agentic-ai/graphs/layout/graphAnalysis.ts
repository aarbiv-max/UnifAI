 ...
 * - Star/hub-and-spoke pattern detection
 * - Depth analysis relative to orchestrator/hub nodes
 *
 * Note: Cycle detection (Tarjan's SCC algorithm) is in tarjan.ts
 */
...
import { detectCycles } from "./tarjan";
...
// Re-export detectCycles from tarjan.ts for backwards compatibility
export { detectCycles } from "./tarjan";
