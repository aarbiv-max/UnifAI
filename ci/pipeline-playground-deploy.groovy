...
def updateGlobalConfigYaml(String filePath) {
    ...
    if (values?.env) {
        ...
        values.env.SSO_BACKEND_HOST = "https://unifai-sso-backend-${params.deploy_namespace}.apps.stc-ai-e1-pp.imap.p1.openshiftapps.com"
    }
...
def updateDeployerEnv() {
    ...
    def sso_env_file = "./UnifAI-secrets/staging/.env_sso_orig"
