...
class BaseAnalyzer:
    def __init__(self, is_cypress: bool = False):
        ...
        self.node_script_path = CY_NODE_SCRIPT_PATH if is_cypress else TS_NODE_SCRIPT_PATH
    ...
    def load_repo(self, repo_path: str) -> Dict[str, Any]:
        ...
        with ThreadPoolExecutor() as executor:
            contents = list(executor.map(lambda pair: (pair[0], self._read_ts_file(pair[1])), ts_files))
