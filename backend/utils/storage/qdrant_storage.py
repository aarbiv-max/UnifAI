...
class QdrantStorage(VectorStorage):
    ...
    def search(
        ...
        # Perform the search using query_points (replaces deprecated search method in 1.16.x)
        ...
        # Convert to standard format - query_points returns QueryResponse with .points
        results = []
