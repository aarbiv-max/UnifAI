...
class Hermes2ProToolParser(ToolParser):
    ...
    def extract_tool_calls_streaming(
        ...
        try:
            ...
            #   autocompleting the JSON
            elif self.current_tool_name_sent and cur_tool_start_count > cur_tool_end_count:
                ...
                self.streamed_args_for_tool[self.current_tool_id] += delta_text
            # elif tool_call_portion is not None and prev_arguments is None:
            #     logger.debug("hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee")
            ...
            # elif tool_call_portion is not None and prev_arguments is not None:
            ...
            logger.debug(f"****************************Tool call delta return: {delta}")
            return delta
