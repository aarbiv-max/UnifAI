...
class SpecDiscoverer:
    ...
    def __init__(
        ...
        """
        self._root = Path(elements_root) if elements_root else Path.cwd() / self.ENTRYPOINT
    ...
    def _import_filesystem_packages(self) -> None:
        ...
        for category_dir in root.iterdir():
            ...
            for element_dir in category_dir.iterdir():
                ...
                module_name = f"{self.ENTRYPOINT}.{category_dir.name}.{element_dir.name}.{self.SPEC_DIR}"
