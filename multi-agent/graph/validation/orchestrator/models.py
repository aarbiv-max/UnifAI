...
from elements.nodes.orchestrator.identifiers import Identifier as OrchestratorIdentifier
from elements.conditions.router_direct.identifiers import Identifier as RouterDirectIdentifier
