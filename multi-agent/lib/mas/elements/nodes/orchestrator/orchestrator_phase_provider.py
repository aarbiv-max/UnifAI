    ...
    def _create_phase_system(self) -> PhaseSystem:
        ...
        allocation_phase = PhaseDefinition(
            ...
            guidance=(
                ...
                "FILE ATTACHMENTS:\n"
                "- If workspace facts contain 'Attached file:' entries, reference them in delegation content\n"
                "- Tell the agent which file(s) to read: 'Use the read_attached_file tool to review [filename] before proceeding'\n"
                "- This ensures agents consult the provided documents rather than relying only on general knowledge\n\n"
                "IMPORTANT:\n"
