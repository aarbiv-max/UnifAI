...
# vLLM Optimized Model Preloader and Deployment Script
# This script uses an optimized git+LFS+aria2 approach for fast, reliable model downloads
...
echo "🚀 Step 1: Deploying optimized model preloader..."
oc apply -f model-preloader.yaml

echo "✅ Optimized model preloader job deployed"
echo ""
