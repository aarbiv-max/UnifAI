...
description: >-
  Structured debugging agent that systematically diagnoses errors, behavioral
  mismatches, and performance issues while respecting hexagonal architecture.
  Use when the pipeline command triggers debug mode, when a pipeline gets stuck
  after exhausting revision loops, or standalone when investigating any issue.
---
